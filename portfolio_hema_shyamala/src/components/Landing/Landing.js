...
import { FaTwitter, FaLinkedin, FaGithub,FaHackerrank } from "react-icons/fa";
                ...
                <div className="landing--container-left" style={{backgroundColor: theme.primary}}>
                    <div className="lcl--content">
                        ...
                        {socialsData.hackerrank && (
                            <a href={socialsData.hackerrank} target="_blank" rel="noreferrer">
                                <FaHackerrank className="landing--social" style={{color: theme.secondary}}/>
                            </a>
                        )}
                    </div>
                </div>
                    ...
                    <div className="lcr--content" style={{color: theme.tertiary}}>
                        ...
                        <div className="lcr-buttonContainer">
                            {headerData.resumePdf && (
                                <a href={headerData.resumePdf} download="hema_shyamala" target="_blank" rel="noreferrer">
